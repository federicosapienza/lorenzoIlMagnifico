 ...
 * 
 * This class represents the reader of the Venture Cards
 *
 */
public class VentureCardsReader extends CardsReader {
	 ...
	 * @param cardsImplementation It's the object to update with the Territory cards read from the file
	 */
	...
	/**
	 * Method that creates a Venture card for the period indicated by the int numOfPeriod contained in the parameter
