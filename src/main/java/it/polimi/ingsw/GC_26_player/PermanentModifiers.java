       ...
       private void addDiscountToExistings(BoardZone zone, ResourcesOrPoints res){
           ResourcesOrPoints temp = discounts.get(zone);
            ...
            if(zone!=null) { //(i.e. Dame effect)
                ...
                //zone==null
                //means that a discount will be applied on every tower: Pico della mirandola effect
                if (discounts.get(BoardZone.TERRITORYTOWER) != null) {
                ...
                if (discounts.get(BoardZone.VENTURETOWER) != null) {
                ...
                if (discounts.get(BoardZone.CHARACTERTOWER) != null) {
                ...
                if (discounts.get(BoardZone.BUILDINGTOWER) != null) {
                    discounts.put(BoardZone.BUILDINGTOWER, ResourcesOrPoints.sum(res, discounts.get(BoardZone.BUILDINGTOWER)));
                    activateFlagDiscountOnResources(BoardZone.BUILDINGTOWER);
                }
                else {
                    discounts.put(BoardZone.BUILDINGTOWER, res);
